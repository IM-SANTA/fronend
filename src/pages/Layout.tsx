...
const Layout = ({ position = 'static', children, ...props }: LayoutProps) => {
  ...
  return (
    <>
      <div {...props} className={`${styles} flex justify-center items-start min-h-screen h-screen`}>
        {/* <div {...props} className="flex justify-center web:items-start md:items-center min-h-screen h-screen"> */}
        <main
          className={`${position} bg-secondary overflow-scroll scrollbar-hide w-[540px] h-[1024px] md:min-w-[540px] md:min-h-[1024px]`}
        >
